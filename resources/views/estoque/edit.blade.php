    ...
    <form action="{{Route("estoque.update", [$material->id])}}" method="post">
        ...
        <div class="">
            ...
            <div class="mb-3 d-flex flex-row justify-content-between">
                <div class="mb-3">
                    <label for="phoneNumber" class="form-label">Fornecedor</label>
                    <input type="tel" class="form-control" id="fornecedor" name="fornecedor" value="{{$material->fornecedor}}">
                </div>
            </div>
            <div class="mb-3">
                <label for="email" class="form-label">Contato do fornecedor</label>
                <input type="email" class="form-control" id="contato" name="contato" value="{{$material->contatoFornecedor}}" aria-describedby="emailHelp">
                <!-- <div id="emailHelp" class="form-text"></div> -->
            </div>
            <div class="mb-3 d-flex flex-row gap-2 justify-content-between">
                <div class="mb-3">
                    <label for="city" class="form-label">Lote</label>
                    <input type="text" class="form-control" id="lote" name="lote" value="{{$material->lote}}">
                </div>
                <div class="mb-3">
                    <label for="neighborhood" class="form-label">Validade do lot</label>
                    <input type="text" class="form-control" id="validadeLote" name="validadeLote" value="{{$material->validadeLote}}">
                </div>
                <div class="mb-3">
                    <label for="street" class="form-label">Preço</label>
                    <input type="text" class="form-control" id="preco" name="preco" value="{{$material->price}}">
                </div>
                <div class="mb-3">
                    <label for="number" class="form-label">Unidade</label>
